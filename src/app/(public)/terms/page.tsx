      ...
      <section className="pt-36 pb-16 bg-gradient-to-b from-slate-50 via-[#FAFBFD] to-[#FAFBFD] dark:from-[#000517] dark:via-[#000517] dark:to-[#000517] border-b border-slate-200/80 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-2 text-xs font-jakarta text-slate-500 dark:text-slate-400 mb-6">
            ...
            <ChevronRight className="w-3.5 h-3.5 text-slate-400" />
            <span className="text-[#0099BE] dark:text-[#00D2FF] font-bold">Terms of Service</span>
          </nav>
          ...
          <main className="w-full lg:w-3/4 bg-white dark:bg-[#000F2E] border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-10 md:p-12 shadow-xl space-y-12 text-slate-700 dark:text-slate-300">
            ...
            <section id="scope-of-services" className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-2 text-xs">
                <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-[#000517] border border-slate-200/80 dark:border-slate-800 font-medium text-slate-700 dark:text-slate-300">
            ...
            {/* Section 2 */}
            <section id="intellectual-property" className="space-y-4 pt-4 border-t border-slate-200/80 dark:border-slate-800">
              <span className="text-[10px] font-bold text-[#0099BE] dark:text-[#00D2FF] uppercase tracking-wider">
                Clause 02
              </span>
              <h2 className="font-outfit text-2xl sm:text-3xl font-black tracking-tight text-[#00144A] dark:text-white">
              ...
              <div className="space-y-3 font-jakarta text-xs sm:text-sm text-slate-700 dark:text-slate-300">
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-[#000517] border border-slate-200 dark:border-slate-800 flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-[#00144A] dark:text-white">Client Deliverable Ownership:</strong> Upon full and final settlement of all applicable invoices, the client receives 100% full intellectual property ownership and commercial rights to bespoke source code, copy, logos, and raw assets created specifically for the project.
                  </div>
                </div>

                <div className="p-4 rounded-xl bg-slate-50 dark:bg-[#000517] border border-slate-200 dark:border-slate-800 flex items-start gap-3">
                  <Lock className="w-4 h-4 text-[#0099BE] dark:text-[#00D2FF] flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-[#00144A] dark:text-white">Agency Core Tooling & Pre-Existing IP:</strong> Nexora retains all ownership rights to proprietary internal libraries, boilerplate scaffolding tools, algorithmic script engines, and generalized design frameworks developed prior to or independently of the engagement.
                  </div>
                </div>
              </div>

              {/* Cyan Highlight Callout Box */}
            ...
            {/* Section 3 */}
            <section id="client-responsibilities" className="space-y-4 pt-4 border-t border-slate-200/80 dark:border-slate-800">
              <span className="text-[10px] font-bold text-[#0099BE] dark:text-[#00D2FF] uppercase tracking-wider">
                Clause 03
              </span>
              <h2 className="font-outfit text-2xl sm:text-3xl font-black tracking-tight text-[#00144A] dark:text-white">
              ...
              <ul className="space-y-3 font-jakarta text-xs sm:text-sm text-slate-700 dark:text-slate-300">
                <li className="flex items-start gap-3">
                  <CreditCard className="w-4 h-4 text-[#0099BE] dark:text-[#00D2FF] flex-shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-[#00144A] dark:text-white">Direct Ad Spend Billing:</strong> All media spend (Meta Ads, Google Ads, TikTok Ads) must be billed directly from the platform to the client&apos;s own credit card or credit line. Nexora manages media accounts as an authorized agency partner and does NOT float third-party ad spend.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <FileCheck className="w-4 h-4 text-emerald-500 flex-shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-[#00144A] dark:text-white">Credential & Access Provisioning:</strong> Clients agree to grant necessary administrative or partner-level access to domain registrars, hosting portals, and CRM systems within 3 business days of onboarding.
                  </span>
                </li>
              </ul>
            </section>
            ...
            {/* Section 4 */}
            <section id="payment-schedules" className="space-y-4 pt-4 border-t border-slate-200/80 dark:border-slate-800">
              <span className="text-[10px] font-bold text-[#0099BE] dark:text-[#00D2FF] uppercase tracking-wider">
                Clause 04
              </span>
              <h2 className="font-outfit text-2xl sm:text-3xl font-black tracking-tight text-[#00144A] dark:text-white">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-jakarta">
                <div className="p-4 rounded-2xl bg-slate-50 dark:bg-[#000517] border border-slate-200 dark:border-slate-800">
                  <h4 className="font-outfit font-bold text-sm text-[#00144A] dark:text-white mb-1">
            ...
            {/* Section 5 */}
            <section id="limitation-of-liability" className="space-y-4 pt-4 border-t border-slate-200/80 dark:border-slate-800">
              <span className="text-[10px] font-bold text-[#0099BE] dark:text-[#00D2FF] uppercase tracking-wider">
                Clause 05
              </span>
              <h2 className="font-outfit text-2xl sm:text-3xl font-black tracking-tight text-[#00144A] dark:text-white">
              ...
              <div className="p-5 rounded-2xl bg-slate-50 dark:bg-[#000517] border border-slate-200 dark:border-slate-800 space-y-3 font-jakarta text-xs sm:text-sm text-slate-700 dark:text-slate-300">
                <div className="flex items-start gap-3">
                  <ShieldAlert className="w-4 h-4 text-amber-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-[#00144A] dark:text-white">Third-Party Algorithm Changes:</strong> Nexora cannot be held liable for sudden policy, ranking algorithm, or auction pricing shifts implemented by Google, Meta, Apple (ITP), or third-party ad networks.
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <ShieldAlert className="w-4 h-4 text-amber-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-[#00144A] dark:text-white">Maximum Liability Cap:</strong> In no event shall Nexora&apos;s aggregate liability arising out of or related to this agreement exceed the total fees actually paid by the client in the three (3) months preceding the claim.
                  </div>
                </div>
              </div>
            </section>
            ...
            {/* Section 6 */}
            <section id="governing-law" className="space-y-4 pt-4 border-t border-slate-200/80 dark:border-slate-800">
              <span className="text-[10px] font-bold text-[#0099BE] dark:text-[#00D2FF] uppercase tracking-wider">
                Clause 06
              </span>
              <h2 className="font-outfit text-2xl sm:text-3xl font-black tracking-tight text-[#00144A] dark:text-white">
